...
class AdaptersNotes(private  var notes:List<NotesDataClass>,context: Context): RecyclerView.Adapter<AdaptersNotes.NoteViewHolder>() {
    ...
    fun refreshData(newNotes : List<NotesDataClass>){
        notes = newNotes
